    ...
    >
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
        ...
        <div className="mt-12 flex justify-center">
          <Link
            href={ctaHref}
            className="rounded-full bg-primary px-8 py-3 text-sm font-heading font-medium uppercase tracking-[0.25em] shadow-md transition hover:bg-accent hover:shadow-lg"
          >
