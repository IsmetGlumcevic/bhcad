...
export function HeroIntro({
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex w-full min-h-screen max-w-[1600px] flex-col justify-center gap-6 px-4 py-20 text-center text-white md:px-6 md:py-24 lg:px-8">
