            ...
            <div className="max-w-xl space-y-6">
              <header>
                ...
                <p className="mt-4 text-white/95 md:text-lg">
                  ...
                  services and how we can help improve your business. Our team
                  is ready to answer all your questions and provide you with the
              ...
              <div className="space-y-4 text-white">
                <div>
                  ...
                  <a href="mailto:info@bhcad.ba" className="mt-1 block text-white/90 underline decoration-white/40 underline-offset-4 hover:decoration-white">
                    info@bhcad.ba
                  </a>
                </div>
                ...
                <div>
                  ...
                  <a href="tel:+38761140810" className="mt-1 block text-white/90">+387 61 140 810</a>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-white/90">Školska 10 Zenica 72 000, Bosnia and Herzegovina</p>
